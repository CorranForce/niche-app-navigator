...
export const Route = createFileRoute("/_authenticated/admin/users")({
  head: () => ({
    meta: [
      { title: "Customer billing — internal dashboard" },
      {
        name: "description",
        content:
          "Internal admin tool: search customers and inspect subscription status, plan, renewal date and billing history.",
      },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Customer billing — internal dashboard" },
      { property: "og:description", content: "Internal customer subscription lookup." },
    ],
  }),
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <h1 className="text-2xl font-semibold tracking-tight">Customer billing</h1>
