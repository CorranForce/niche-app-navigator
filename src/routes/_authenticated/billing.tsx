...
export const Route = createFileRoute("/_authenticated/billing")({
  head: () => ({
    meta: [
      { title: "Billing — MicroSaaS Solution Finder" },
      {
        name: "description",
        content:
          "View your current plan, switch between Free, Pro and Studio, update payment details or cancel your subscription.",
      },
      { property: "og:title", content: "Billing — MicroSaaS Solution Finder" },
      {
        property: "og:description",
        content: "Manage your MicroSaaS Solution Finder plan, upgrades and cancellations.",
      },
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        ...
        <h1 className="mt-3 text-3xl font-semibold">Your plan</h1>
          ...
          {PLANS.map((p) => {
            ...
            return (
              ...
              >
                ...
                {p.id === "free" ? (
                  <Button variant="outline" className="mt-2" disabled={!isActive} onClick={handleCancel}>
