    ...
    caseStudies: [
          {
                ...
                "challenge": "Front desk booked everything by phone and wrote it into a paper day sheet. Roughly one in five patients simply didn't turn up, and freed slots stayed empty because nobody had time to ring the waitlist.",
                "build": "A reminder-and-confirm loop: SMS 48 hours and 3 hours out with one-tap confirm or reschedule, plus a waitlist queue that auto-offers a cancelled slot to the next three patients.",
                "result": "No-show rate fell from 22% to 6% and about 11 previously dead slots per month were backfilled \u2014 roughly $3,400 of recovered chair time.",
                "quote": "The report told us to ship reminders first and waitlist second. That order was right \u2014 reminders alone paid for the build in a month.",
          ...
          },
          {
                ...
                "challenge": "Peak classes filled on Instagram DMs, then a third of bookers dropped out overnight and the class ran half-empty while a waitlist existed.",
                "build": "Deposit-gated booking with a small card hold released on attendance, and an automatic waitlist promotion 12 hours before class.",
                "result": "Average class fill rose from 62% to 89%, and DM booking traffic dropped to near zero within three weeks.",
                "quote": "I thought a deposit would scare people off. It filtered exactly the people who never showed.",
                "author": "Studio owner",
          ...
          },
          {
                ...
                "challenge": "Every booking needed a call to check whether the van could get across town in time, so quoting a slot took three messages.",
                "build": "A booking page that only offers slots compatible with that day's existing route, with automated confirmation and day-before reminder.",
                "result": "Booking admin dropped from about two hours a day to fifteen minutes, and one extra appointment per day now fits in the route.",
                "quote": "It solved the scheduling problem and the driving problem at once. I didn't expect one small app to do both.",
    ...
    caseStudies: [
          {
                ...
                "challenge": "New client details were captured on a printed form, typed into the case system, then typed again into the billing spreadsheet.",
                "build": "A mobile intake form that writes straight into the case record, plus a one-click push of the finished matter into accounting.",
                "result": "About 9 hours of paralegal re-typing removed per week and intake errors dropped to near zero because data is entered once.",
                "quote": "The build order in the report was the useful part: intake first, because everything downstream needs that data clean.",
          ...
          },
          {
                ...
                "challenge": "Every move produced an inventory sheet, a damage waiver and a signed completion form, all on paper and all re-keyed on Monday.",
                "build": "A template library with autofill and on-site signature capture, syncing each completed job to the office instantly.",
                "result": "Paperwork time per move fell from ~40 minutes to ~8, and disputed damage claims dropped because photos attach to the record.",
          ...
          },
          {
                ...
                "challenge": "The owner spent most of Sunday copying job sheets into the accounting tool and reconciling card payouts by hand.",
                "build": "Job records that generate the accounting entry on completion, with a weekly reconciliation view.",
    ...
    caseStudies: [
          {
                ...
                "challenge": "Enquiries arrived via website form, Instagram and voicemail. Replies often took two days, by which point couples had booked elsewhere.",
                "build": "A unified lead inbox with an instant acknowledgement plus one qualifying question, then a three-step nudge cadence.",
                "result": "Median first-reply time went from 31 hours to under 5 minutes, and booked consultations roughly doubled over a season.",
                "quote": "Speed was the whole game and I couldn't see it until every channel was in one list.",
                "author": "Photographer",
          ...
          },
          {
                ...
                "challenge": "Nobody knew which agent owned which enquiry, so some leads got three replies and others got none.",
                "build": "A shared queue with explicit owner and status, plus an unanswered-after-24h escalation to the owner.",
                "result": "Unanswered enquiries fell from an estimated 18% to under 2%, with a measurable lift in quotes sent per week.",
          ...
          },
          {
                ...
                "challenge": "Quotes were sent once and never chased; anyone who didn't reply was silently written off.",
                "build": "A scheduled cadence of three polite nudges tied to quote status, stopping automatically on reply or booking.",
    ...
    caseStudies: [
          {
                ...
                "challenge": "Quotes were written up back at the shop from memory, arriving two days later with inconsistent pricing.",
                "build": "A mobile estimator with a line-item catalogue, margin rules and instant PDF send.",
                "result": "Quote turnaround dropped from ~2 days to under 10 minutes and win rate rose from 34% to 51%.",
          ...
          },
          {
                ...
                "challenge": "Different staff quoted the same two-bedroom move up to $200 apart, and nobody could explain why.",
                "build": "A quote builder where volume, distance and access drive price from a shared catalogue with locked margin floors.",
                "result": "Price variance on comparable jobs fell under 5%, and average gross margin rose 6 points.",
          ...
          },
          {
                ...
                "challenge": "Event quotes went out constantly with no record of what converted or at what margin.",
                "build": "Quote tracking with win rate by event type, price band and lead source.",
                "result": "Two whole event categories were dropped, and time freed went into the two that converted at 60%+.",
    ...
    caseStudies: [
          {
                ...
                "challenge": "Invoices were raised manually at month end and chased by personal text, with no card option.",
                "build": "Job-to-invoice automation that bills on lesson completion, with card payment on the invoice and scheduled reminders.",
                "result": "Unpaid lessons fell from 12% to about 1% and average days-to-payment dropped from 26 to 4.",
                "quote": "I stopped being the person who texts people about money. The system does it politely.",
                "author": "Instructor",
          ...
          },
          {
                ...
                "challenge": "Wholesale orders paid on varying terms and the owner had no idea what was actually landing in the next 30 days.",
                "build": "An expected-in dashboard reading from invoice status, with a simple overdue split.",
                "result": "Kiln and materials purchases moved onto a planned cycle; two overdrafts in the prior year became none.",
          ...
          },
          {
                ...
                "challenge": "Overdue matters sat untouched because chasing clients felt awkward and nobody owned it.",
                "build": "A scheduled dunning ladder with escalating but professional wording, pausing automatically on partial payment.",
                "result": "About $18,000 of receivables over 60 days old was collected in the first quarter after launch.",
    ...
    caseStudies: [
          {
                ...
                "challenge": "Couples asked the same 'where are my photos?' question weekly across text, email and Instagram.",
                "build": "One status link per booking showing stage, gallery links and next step, updated once by the photographer.",
                "result": "Inbound status messages dropped roughly 70% and delivery-related complaints stopped entirely.",
          ...
          },
          {
                ...
                "challenge": "Documents sat awaiting client sign-off with no reminder and no record of who was blocking.",
                "build": "Structured approval requests with automatic reminders and a logged, timestamped sign-off.",
          ...
          },
          {
                ...
                "challenge": "When a carrier cancelled, agents phoned every affected traveller individually and still missed some.",
                "build": "Broadcast updates posted once to every active client, with per-client acknowledgement tracking.",
                "result": "A day that previously took the whole team was handled in under an hour, with a full record of who was informed.",
